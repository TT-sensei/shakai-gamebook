...
{id:"j2",title:"部品をつくる会社と協力する",text:"一台のクルマには、たくさんの部品が必要です。自社だけでなく、さまざまな会社が部品の開発や生産に関わります。",requiredLearning:["division","global"],educationalIntent:"自動車づくりが、多くの会社の分担と協力でできていることを知る。",choices:[
...
stamping:[
{id:"j3",title:"鋼板から部品をつくる",text:"大きな鉄の板を切ったり、プレスしたりして、ドアや車体などの部品をつくります。ここでは、材料をむだなく使うことも大切です。",requiredLearning:["technology","environment","quality"],educationalIntent:"プレス工程で鋼板から車体部品をつくり、材料の性質や使い方を考えていることを捉える。",choices:[
...
assembly:[
{id:"j6",title:"必要な部品をそろえる",text:"組立ラインには、注文に合わせて必要な部品を届けます。一台ごとにちがう部品を、まちがえずに取りつけることが大切です。",requiredLearning:["division","technology","quality"],educationalIntent:"いろいろな車をつくる組立で、必要な部品をそろえる仕組みを知る。",choices:[
...
{id:"j8",title:"工程の中で品質を確認する",text:"組み立ての途中で部品の取り付けに異常が見つかりました。次の工程へ送る前に、どうするか判断します。",requiredLearning:["quality","safety"],educationalIntent:"おかしいところを見つけたら、仕事を止めて直すなど、よい車をつくる考え方を知る。",choices:[
...
delivery:[
{id:"j11",title:"完成車を運ぶ",text:"検査に合格した完成車を、販売店や港へ運びます。届け先や台数、時間を考えて輸送方法を決めます。",requiredLearning:["logistics","global"],educationalIntent:"完成した車を、日本や外国へ運ぶ仕組みと計画を知る。",choices:[
...
{id:"j12",title:"販売の情報を次の生産へつなぐ",text:"販売店から、どんな車が求められているかという情報が届きました。次のクルマづくりにどう生かすか考えます。",requiredLearning:["global","division","quality"],educationalIntent:"お店などからの情報が、次の車づくりにつながることを知る。",choices:[
...
EVENTS:[
{id:"ev_parts",name:"部品の到着が遅れる",stages:["planning","assembly"],weight:1,title:"部品が予定どおり届かない",text:"組立に使う部品の到着が予定より遅れることが分かりました。多くの会社が関わる中で、どう対応するか考えます。",requiredLearning:["division","logistics"],educationalIntent:"分業では部品が届くことや、情報を伝え合うことが、車づくり全体につながると考える。",choices:[
...
{id:"ev_line",name:"工程の異常",stages:["stamping","welding","painting","assembly"],weight:1,title:"ラインで異常を発見",text:"作業中に、部品の取り付けや設備に異常があることが分かりました。生産を続けるか、止めるかを判断します。",requiredLearning:["quality","safety","technology"],educationalIntent:"異常があれば知らせてラインを止め、品質を守る仕組みを考える。",choices:[
...
{id:"ev_improve",name:"もっと働きやすくできないか",stages:["stamping","assembly"],weight:1,title:"現場から改善案が出る",text:"作業する人から「ここを変えれば、もっと安全で作業しやすくなる」という提案が出ました。どうするか考えます。",requiredLearning:["technology","safety","quality"],educationalIntent:"現場の気づきを改善につなげることが生産を支えていることを捉える。",choices:[
...
{id:"ev_environment",name:"環境への工夫",stages:["painting","inspection"],weight:1,title:"環境への負担を減らしたい",text:"工場で使うエネルギーや材料を見直すことになりました。生産を止めずに、環境への負担を減らす方法を考えます。",requiredLearning:["environment","technology"],educationalIntent:"車づくりをしながら、環境への負担を減らす工夫を考える。",choices:[
...
{id:"ev_compete",name:"ほかのメーカーとの競争",stages:["planning","delivery"],weight:1,title:"ほかのメーカーも新しい車を発表",text:"ほかの自動車メーカーが、新しい車を発表しました。自分たちも急いで対抗するべきか、考えます。",requiredLearning:["quality","technology","global"],educationalIntent:"ほかの会社と競争していても、安全やよい車づくりを大切にして、もっとよくすることを考える。",choices:[
