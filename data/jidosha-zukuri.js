...
CORE_SCENES:{
planning:[
{id:"j1",title:"どんなクルマをつくる？",text:"新しいクルマを企画します。どんなクルマにするか、いくつかの案を考えることになりました。",requiredLearning:["division","quality"],educationalIntent:"自動車づくりが企画から始まり、社会や使う人の変化を考えて進められることを捉える。",choices:[
...
{id:"j2",title:"部品をつくる会社と協力する",text:"一台のクルマには、たくさんの部品があります。部品をつくる会社もいろいろあります。",requiredLearning:["division","global"],educationalIntent:"自動車づくりが、多くの会社の分担と協力でできていることを知る。",choices:[
...
stamping:[
{id:"j3",title:"鋼板から部品をつくる",text:"大きな鉄の板を切ったり、プレスしたりして、ドアや車体などの部品をつくります。材料の使い方をどうするか考えます。",requiredLearning:["technology","environment","quality"],educationalIntent:"プレス工程で鋼板から車体部品をつくり、材料の性質や使い方を考えていることを捉える。",choices:[
...
welding:[
{id:"j4",title:"車体の形にする",text:"プレスでできた部品をつなぎ合わせ、車体の形にしていきます。できた車体を、次の工程へ送ることになりました。",requiredLearning:["technology","quality","safety"],educationalIntent:"溶接によって車体を組み上げ、工程ごとに品質を確認することを捉える。",choices:[
...
painting:[
{id:"j5",title:"車体をきれいに塗る",text:"車体を洗浄してから、下塗りやシーラー、中塗り、上塗り、クリアなどを行います。どんな順番や方法で進めるか考えます。",requiredLearning:["quality","technology"],educationalIntent:"塗装工程では複数の工程を重ね、品質を守るための細かな管理をしていることを捉える。",choices:[
...
assembly:[
{id:"j6",title:"必要な部品をそろえる",text:"組立ラインには、注文に合わせて部品を届けます。一台ごとにちがう部品を取りつけます。",requiredLearning:["division","technology","quality"],educationalIntent:"いろいろな車をつくる組立で、必要な部品をそろえる仕組みを知る。",choices:[
...
{id:"j7",title:"人と機械で組み立てる",text:"組立では、配線、内装、エンジンや足回り、タイヤ、シート、ガラスなど、たくさんの部品を取りつけます。人と機械で仕事を進めます。",requiredLearning:["technology","division","safety"],educationalIntent:"組立工程で人と機械が役割を分担し、品質と安全を守りながら作業していることを捉える。",choices:[
...
{id:"j8",title:"工程の中で品質を確認する",text:"組み立ての途中で、部品の取りつけにおかしいところが見つかりました。次の工程へ送る前に、どうするか考えます。",requiredLearning:["quality","safety"],educationalIntent:"おかしいところを見つけたら、仕事を止めて直すなど、よい車をつくる考え方を知る。",choices:[
...
inspection:[
{id:"j9",title:"完成車を検査する",text:"組立が終わった車を一台ずつ調べます。部品、車体、ライトやメーターなどを見て、出荷してよいか考えます。",requiredLearning:["quality","safety"],educationalIntent:"最終検査で一台ずつ厳しく品質を確認してから出荷することを捉える。",choices:[
...
{id:"j10",title:"環境への配慮を考える",text:"工場では、電気や材料などを使います。車をつくる中で、どんなことを考えたらよいでしょうか。",requiredLearning:["environment","technology"],educationalIntent:"生産効率だけでなく、エネルギーや資源、排出などへの配慮も行われることを捉える。",choices:[
...
{id:"ev_environment",name:"環境への工夫",stages:["painting","inspection"],weight:1,title:"環境への負担を減らしたい",text:"工場で使う電気や材料について、見直すことになりました。どうするか考えます。",requiredLearning:["environment","technology"],educationalIntent:"車づくりをしながら、環境への負担を減らす工夫を考える。",choices:[
...
{id:"ev_compete",name:"ほかのメーカーとの競争",stages:["planning","delivery"],weight:1,title:"ほかのメーカーも新しい車を発表",text:"ほかの自動車メーカーが、新しい車を発表しました。自分たちはどうするか考えます。",requiredLearning:["quality","technology","global"],educationalIntent:"ほかの会社と競争していても、安全やよい車づくりを大切にして、もっとよくすることを考える。",choices:[
...
{text:"プレス",correct:true,feedback:"正解。大きな鋼板から、車体の部品をつくります。"},
...
{text:"溶接",correct:true,feedback:"正解。部品をつないで、車体の形にしていきます。"},
