...
EVENTS:[
{id:"ev_parts",name:"部品の到着が遅れる",stages:["planning","assembly"],weight:1,title:"部品が予定どおり届かない",text:"組立に使う部品の到着が予定より遅れることが分かりました。多くの会社が関わる中で、どう対応するか考えます。",requiredLearning:["division","logistics"],educationalIntent:"分業では部品の供給や情報共有が生産全体につながることを考える。",choices:[
...
{id:"ev_environment",name:"環境への工夫",stages:["painting","inspection"],weight:1,title:"環境への負担を減らしたい",text:"工場で使うエネルギーや材料を見直すことになりました。生産を止めずに、環境への負担を減らす方法を考えます。",requiredLearning:["environment","technology"],educationalIntent:"生産活動の中で環境への負担を減らす工夫を考える。",choices:[
